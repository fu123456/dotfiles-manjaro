...
(setq orca-handler-list
      '((orfu-handle-link-youtube)
        ...
        (orca-handler-match-url "http://stackoverflow.com/" "~/MEGA/org/stack.org" "Questions")
        (orca-handler-match-url "https://www.reddit.com/" "~/MEGA/org/wiki/emacs.org" "Reddit")
        (orca-handler-match-url "https://emacs.stackexchange.com/" "~/MEGA/org/wiki/emacs.org" "\\* Questions")
        (orca-handler-current-buffer "\\* Tasks")
        (orca-handler-file "~/MEGA/org/ent.org" "\\* Articles")))
